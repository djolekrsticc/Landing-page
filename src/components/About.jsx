        ...
        <section className="container mx-auto" id="about">
            <div className="flex flex-col mx-7 justify-between items-center mt-28 md:mt-28">
                <div className="w-full md:w-5/12 md:pr-10">
                    <div className="flex flex-row items-center py-5 md:py-0">
                ...
                <div className="flex flex-row items-center mt-9 w-full">
                    <a href="about" className="w-full">
                        <div className="flex flex-row justify-center items-center w-full py-4 md:py-5 px-5 bg-primary-color hover:bg-primary-color-light active:bg-primary-color-light rounded-full cursor-pointer">
                            <p className="text-white text-base pr-3">About us</p>
